...
export default function CrystalOrbHud({ state }: { state: OrbVisualState }) {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-[1]">
      ...
      <div className="absolute inset-[8%] rounded-full border border-cyan-300/10 shadow-[inset_0_0_80px_rgba(40,167,255,0.06)]" />
      ...
      <motion.div
        className="absolute inset-[24%] rounded-full border border-cyan-100/10 bg-[linear-gradient(145deg,rgba(7,18,29,0.94),rgba(7,13,20,0.88))] backdrop-blur-xl shadow-[inset_0_0_40px_rgba(0,174,255,0.12)]"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
          <div className="text-center">
            <motion.div
              ...
              className="font-sans text-[11px] font-bold uppercase tracking-[0.6em] text-cyan-300 drop-shadow-[0_0_12px_rgba(34,211,238,0.5)] sm:text-[14px]"
            >
              Jarvis
            </motion.div>
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="mt-3 font-sans text-2xl font-black uppercase tracking-[0.15em] text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.3)] sm:mt-4 sm:text-3xl"
              >
                {config.label}
              </motion.div>
            </AnimatePresence>
